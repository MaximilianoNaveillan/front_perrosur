...
import { FaRegImages, FaMoneyBillAlt } from "react-icons/fa";
...
export default function EquipoForm({ path, _class, equipos }) {
  ...
  const handleImageData = async (imageData) => {
    if (imageData) {
      ...
      const imgFile = dataURLtoFile(imageData, `tienda-blog-${key}.png`);
  ...
  const putData = async (form, imageData) => {
    setLoad({
      state: true,
      status: 200,
      msg: "Cargando.",
  ...
  const postData = async (form, imageData) => {
    ...
    axiosFetch
      ...
      .then((res) => {
        ...
        const data = res.data.tienda;
        const body = new FormData();
        const imgFile = dataURLtoFile(imageData, `tienda-blog-${data._id}.png`);
        body.append("file", imgFile);
        ...
        <div>
          <div className="card-title">
            <div className="row">
              <div className="col-8">
                <h1 className=" title">
                  {key ? `EDITANDO TIENDA` : "AGREGANDO A LA TIENDA"}
                </h1>
              </div>
              <div className="col-4">
                <Link href={path}>
                  ...
                  <div className="row">
                    <div className="col-12 mb">
                      ...
                      <CropImg
                        ...
                        key="img-upload-1"
                        contentheight="50vh"
                        url={key ? `/images/tienda-blog-${key}.png` : undefined}
                      />
                    </div>
                  </div>
                </div>
                        ...
                        <div className="omrs-input-group">
                          ...
                          >
                            <input
                              ...
                              required
                            />
                            <span className="omrs-input-label">TÍTULO</span>
                        ...
                        <div className="omrs-input-group">
                          <label className="omrs-input-filled">
                            <input
                              ...
                              onChange={handleChange}
                            />
                            <span className="omrs-input-label">VALOR</span>
                            <span className="omrs-input-helper">
                              <>&nbsp;</>
                            </span>
                            <FaMoneyBillAlt />
