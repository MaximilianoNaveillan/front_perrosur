...
export default function EquipoForm({ path, _class }) {
  ...
  const handleImageData = async (imageData) => {
    if (imageData) {
      ...
      const imgFile = dataURLtoFile(imageData, `actualidad-blog-${key}.png`);
  ...
  const postData = async (form, imageData) => {
    ...
    axiosFetch
      ...
      .then((res) => {
        ...
        const data = res.data.actualidad;
        const body = new FormData();
    ...
    <>
        ...
        <div>
          <div className="card-title">
            <div className="row">
              <div className="col-8">
                <h1 className=" title">
                  {key ? `EDITANDO ACTUALIDAD` : "AGREGANDO ACTUALIDAD"}
                </h1>
              </div>
              <div className="col-4">
                <Link href={path}>
                        ...
                        <div className="omrs-input-group">
                          ...
                          >
                            <input
                              ...
                              required
                            />
                            <span className="omrs-input-label">FACEBOOK</span>
                            <span className="omrs-input-helper">
                              {namevalid ? <>&nbsp;</> : "nombre requerido"}
                            </span>
                            <FaFacebook />
                        ...
                        <div className="omrs-input-group">
                          ...
                          >
                            <input
                              ...
                              required
                            />
                            <span className="omrs-input-label">INSTAGRAM</span>
                            <span className="omrs-input-helper">
                              {namevalid ? <>&nbsp;</> : "nombre requerido"}
                            </span>
                            <FaInstagramSquare />
      ...
      <style jsx>{`
        ...
        input[type="date"] {
          ...
          background: transparent right 1rem center no-repeat;
