...
export default function EquipoForm({ path, _class, equipos }) {
  ...
  const handleImageData = async (_imageData) => {
    if (_imageData) {
      ...
      const imgFile = dataURLtoFile(_imageData, `tienda-blog-${key}.png`);
                  ...
                  <div className="row">
                    <div className="col-12 mb">
                      ...
                      <CropImg
                        ...
                        url={
                          key
                            ? `${S_URL}/uploadimg/image/tienda-blog-${key}.png`
                            : undefined
                        }
                      />
                    </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row">
                      <div className="col-12">
                        ...
                        <div className="omrs-input-group">
                          <label htmlFor="val" className="omrs-input-filled">
                            <input
                              type="number"
                              value={form.val}
                              id="val"
