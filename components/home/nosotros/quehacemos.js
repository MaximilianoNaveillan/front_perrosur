                  ...
                  <div className="aspect-1">
                    <div className="content-img">
                      <div className="card-img">
                        <Img
                          src={`/images/quehacemos1.jpg`}
                          name="Producción a pequeña esacala"
                        />
                      </div>
                    </div>
                  </div>
